...
"""
Notification daemon wrapper for generic scheduler daemon.

Instantiates SchedulerDaemon with notification-specific parameters
to handle game reminder notifications.
"""
