...
class DiscordMessageEventData(BaseModel):
    ...
    message_id: Optional[str] = None  # For updates
...
class ConfigUpdateEventData(BaseModel):
    ...
    guild_id: str
    channel_id: Optional[str] = None  # None for guild-level updates
...
def get_routing_key(event_type: EventType, guild_id: Optional[str] = None) -> str:
...
def get_queue_name(service_name: str, event_type: Optional[EventType] = None) -> str:
