...
class ParticipantResponse(BaseModel):
    ...
    discord_id: Optional[str] = Field(None, description="Discord user ID (None for placeholders)")
    display_name: Optional[str] = Field(None, description="Resolved display name or placeholder text")
