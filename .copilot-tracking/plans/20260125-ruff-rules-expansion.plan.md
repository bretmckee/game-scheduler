...
- services/\*_/_.py - Production code requiring security and quality improvements
- tests/\*_/_.py - Test code with specific rule exceptions
...
- [x] Task 5.1: Add function argument and return type hints
  ...
  - Fixed: **init** methods, signal handlers, database cursors, pika channels, API routes, callbacks
