...
- [services/api/services/games.py](services/api/services/games.py) - Extracted _update_simple_text_fields(), _update_scheduled_at_field(), _update_schedule_affecting_fields(), and _update_remaining_fields() helpers, refactored _update_game_fields() to reduce complexity from C:13/Cog:16 to below thresholds
