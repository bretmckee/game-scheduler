...
**Related Plan**: 20251222-discord-client-token-unification.plan.md
...
- tests/shared/discord/test*client.py - Renamed test methods for clarity (test_get_guilds*_ instead of test*get_user_guilds*_ and test*get_bot_guilds*\*)
