...
**Related Plan**: 20251226-multiple-signup-methods.plan.md
...
- shared/models/**init**.py - Exported SignupMethod enum
...
- frontend/src/components/**tests**/GameForm.test.tsx - Frontend unit tests for signup method selector (8 tests): default SELF_SIGNUP, template default, disabled when one method, enabled when multiple, edit mode preservation, description display, description updates, form data inclusion
