...
**Related Plan**: 20260101-centralized-query-layer-deduplication-security.plan.md
...
- shared/data_access/**init**.py - Package initialization for centralized guild-scoped query layer
...
- tests/shared/data_access/**init**.py - Test package initialization for data_access tests
