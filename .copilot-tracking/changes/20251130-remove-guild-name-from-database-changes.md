...
**Related Plan**: 20251130-remove-guild-name-from-database-plan.instructions.md
...
- `.copilot-tracking/plans/20251130-remove-guild-name-from-database-plan.instructions.md` - Tracked implementation progress
